		...
		<form method="post" action="<c:url value="/creationCommande"/>">
			...
			<fieldset>
				...
				<br> <label for="montantCommande">Montant <span
					...
					siez="30" maxlength="30" /> <span class="erreur">${form.erreurs['montantCommande']}</span>
				<br> <label for="modePaiementCommande">Mode de paiement
					<span class="requis">*</span>
				</label> <input type="text" in="modePaiementCommande"
				...
				<br> <label for="modeLivraisonCommande"
					name="modeLivraisonCommande">Mode de livraison<span
					class="requis">*</span></label> <input type="text"
					id="modeLivraisonCommande" name="modeLivraisonCommande"
